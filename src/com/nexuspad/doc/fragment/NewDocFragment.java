...
public class NewDocFragment extends NewEntryFragment<NPDoc> {
    public static final String TAG = "NewDocFragment";

    protected static final int REQ_PICK_FILE = REQ_SUBCLASSES + 1;

    public static interface Callback extends NewEntryFragment.Callback<NPDoc> {
        void onUpdateEntry(NPDoc entry);
    }

    public static NewDocFragment of(NPFolder folder) {
        return of(null, folder);
    }

    public static NewDocFragment of(NPDoc doc, NPFolder f) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        mFolderV = (EditText)view.findViewById(R.id.lbl_folder);
