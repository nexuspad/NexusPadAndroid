...
public abstract class SinglePaneActivity extends NPNavigateActivity {
    ...
    /**
     * Calls {@link android.support.v4.app.FragmentTransaction#add(int, android.support.v4.app.Fragment, String)} if the
     * {@code Activity} is freshly created.<br />
     * <br />
     *
     * If the {@code Activity} is returned from an orientation change, no
     * {@link android.support.v4.app.FragmentTransaction} will be performed.
     */
    @Override
    ...
    /**
     * Called during every time {@link #onCreate(android.os.Bundle)} is invoked, clients
    ...
    /**
     * Called during {@link #onCreate(android.os.Bundle)}, client may override this method
     ...
     *
     * @param ft
     *            A {@link android.support.v4.app.FragmentTransaction} to be committed right after this
     *            method returns.
     */
    ...
    /**
     * Called during {@link #onCreate(android.os.Bundle)} if necessary.
     *
