 ...
 * @author Edmond
 */
@FragmentName(UpdateFolderFragment.TAG)
public class UpdateFolderFragment extends DialogFragment {
	public static final String TAG = "UpdateFolderFragment";
	...
	/**
	 * @return a {@link UpdateFolderFragment} with a parent folder
	 */
	public static UpdateFolderFragment of(NPFolder parent) {
		return UpdateFolderFragment.of(parent, null);
	}

	/**
	 * @return a {@link UpdateFolderFragment} with a default folder name
	 */
	public static UpdateFolderFragment of(NPFolder parent, NPFolder folder) {
		Bundle bundle = new Bundle();
		bundle.putParcelable(KEY_FOLDER, parent);
		bundle.putParcelable(KEY_ORIGINAL_FOLDER_NAME, folder);

		UpdateFolderFragment fragment = new UpdateFolderFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.folder_update_frag, container, false);
	}
	...
	private void installListeners() {
		mFolderV.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = FoldersNavigatorActivity.ofParentFolder(activity, root);
