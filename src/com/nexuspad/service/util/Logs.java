...
public final class Logs {
    ...
    // For logcat filtering
    private static String appName = "NP - ";
    private static boolean sShouldLog = true;

    /**
     * @param sShouldLog disables all logging calls if false
     */
    ...
    public static void v(String tag, String msg, Throwable tr) {
        if (sShouldLog) {
            Log.v(appName.concat(tag), msg, tr);
        }
    }
    ...
    public static void d(String tag, String msg, Throwable tr) {
        if (sShouldLog) {
            Log.d(appName.concat(tag), msg, tr);
        }
    }
    ...
    public static void i(String tag, String msg, Throwable tr) {
        if (sShouldLog) {
            Log.i(appName.concat(tag), msg, tr);
        }
    }
    ...
    public static void w(String tag, String msg, Throwable tr) {
        if (sShouldLog) {
            Log.w(appName.concat(tag), msg, tr);
        }
    }
    ...
    public static void e(String tag, String msg, Throwable tr) {
        if (sShouldLog) {
            Log.e(appName.concat(tag), msg, tr);
        }
    }
